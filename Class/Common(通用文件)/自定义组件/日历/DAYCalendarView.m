...
- (void)jumpToMonth:(NSUInteger)month year:(NSUInteger)year {
    ...
    //self.navigationBar.textLabel.text = @"";
    
    [UIView transitionWithView:_navigationBar.textLabel duration:0.3 options:UIViewAnimationOptionTransitionCrossDissolve animations:^{
        _navigationBar.textLabel.text = self.navigationBarTitle;
        
    } completion:nil];
    
    //self.navigationBar.textLabel.text = [NSString stringWithFormat:@"%u",arc4random()%100];
